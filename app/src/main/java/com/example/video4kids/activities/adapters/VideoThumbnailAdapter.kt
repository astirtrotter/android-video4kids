...
import kotlinx.android.synthetic.main.adapter_video_thumbnail.view.*
import java.io.File

class VideoThumbnailAdapter(private val activity: RelatedVideosActivity,
                            private val items: ArrayList<VideoItem>) : RecyclerView.Adapter<VideoThumbnailAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, i: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.adapter_video_thumbnail, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: MyViewHolder, i: Int) {
        ...
        itemView.subtitleTV.text = item.title
        Glide.with(activity)
